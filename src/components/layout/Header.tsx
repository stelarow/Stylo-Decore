      ...
      >
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 lg:px-6">
          ...
          <a
            ...
            className="hidden shrink-0 lg:flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:bg-[#1fb855] hover:shadow-lg"
          >
