...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/papeis-de-parede/boho`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/papeis-de-parede/natural`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/papeis-de-parede/natureza`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
